...
<head>
  ...
  <script type="text/javascript" src="../Setr.us/music/uploader/javascript/jquery-1.3.2.min.js"></script>
  <script type="text/javascript" src="../Setr.us/music/uploader/javascript/jquery-ui-1.7.2.custom.min.js"></script>
  <script type="text/javascript" src="../Setr.us/music/uploader/javascript/jquery.qtip-1.0.0-rc3.js"></script>
  <link rel=StyleSheet href="../Setr.us/music/uploader/jquery-ui-1.7.2.custom.css" type="text/css" media="screen">
    ...
    $('p.remove_song').bind("click", function(){
	  ...
	  /*add sugue arrow clickability*/
		$('.segue_indic').click(function(){
          ...
          $(this).attr('src', '../Setr.us/uploader/images/ul_segue_hollow.png');
        }
        else{
          $(this).addClass("segue");
          $(this).attr('src', '../Setr.us/uploader/images/ul_segue_darkGreen.png');          
        }
    });
